...

{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-17230d42-26bd-4a1e-a5f3-5b99dfad56ce" = [ ];
      ...
      "google-chrome-personal.desktop"."_launch" = "Meta+W";
      "google-chrome.desktop"."_launch" = "Meta+Q";
      "google-chrome.desktop"."new-private-window" = [ ];
      ...
      "kdeconnect-cli.desktop"."_launch" = "Meta+Shift+Y";
      ...
      "kwin"."Edit Tiles" = "Meta+Shift+Return";
      "kwin"."Expose" = "Ctrl+F9";
      ...
      "org_kde_powerdevil"."PowerOff" = ["Meta+Shift+I" "Power Off"];
      ...
      "plasmashell"."show-on-mouse-pos" = "Meta+Ctrl+H";
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."17230d42-26bd-4a1e-a5f3-5b99dfad56ce" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "17230d42-26bd-4a1e-a5f3-5b99dfad56ce";
      "kcminputrc"."Keyboard"."NumLock" = 0;
      "kcminputrc"."Libinput.2.8.AlpsPS/2 ALPS DualPoint TouchPad"."TapToClick" = true;
      "kcminputrc"."Mouse"."cursorTheme" = "Yaru";
      ...
      "kglobalshortcutsrc"."google-chrome-personal.desktop"."_k_friendly_name" = "Chrome Personal";
      "kglobalshortcutsrc"."google-chrome.desktop"."_k_friendly_name" = "Google Chrome";
      ...
      "kglobalshortcutsrc"."kdeconnect-cli.desktop"."_k_friendly_name" = "kdeconnect-cli --refresh";
      "kglobalshortcutsrc"."kded5"."_k_friendly_name" = "KDE Daemon";
      "kglobalshortcutsrc"."khotkeys"."_k_friendly_name" = "Служба пользовательских комбинаций клавиш";
      ...
      "kglobalshortcutsrc"."org.kde.plasma-systemmonitor.desktop"."_k_friendly_name" = "Системный монитор";
      "kglobalshortcutsrc"."org.kde.plasma.emojier.desktop"."_k_friendly_name" = "Emoji Selector";
      "kglobalshortcutsrc"."org_kde_powerdevil"."_k_friendly_name" = "Управление питанием";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{bba127b6-bea4-4dcf-aea4-e155e416e76d}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{e8a5631b-5b21-43c2-b602-4e8ab4416596}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{560dc889-a0d0-46ac-b620-14ef2a057d96}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{5155e820-2bfe-4e0a-bdd1-84e28111ae71}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{ae734dfe-0012-4bc0-82e5-abcd326c1d7e}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{821ecbf0-f0a1-4c04-bc1f-11388d68c88a}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{972e9016-5081-46d3-ae76-8e3978eefd9a}";
      ...
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."Image" = "/usr/share/backgrounds/warty-final-ubuntu.png";
      "kscreenlockerrc"."Greeter.Wallpaper.org.kde.image.General"."PreviewImage" = "/usr/share/backgrounds/warty-final-ubuntu.png";
      "kwalletrc"."Wallet"."Close When Idle" = false;
      "kwalletrc"."Wallet"."Close on Screensaver" = false;
      "kwalletrc"."Wallet"."Default Wallet" = "kwallet";
      ...
      "kwinrc"."Desktops"."Id_1" = "ce5d9ef9-3726-426b-99a2-6503e0a145e2";
      "kwinrc"."Desktops"."Id_2" = "a269769d-580d-459d-ac30-bba8c0925042";
      "kwinrc"."Desktops"."Number" = 2;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-windowview"."BorderActivate" = 7;
      "kwinrc"."Effect-windowview"."BorderActivateAll" = 9;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."NightTemperature" = 2000;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling.a1215720-71a5-50fd-b6f3-fec99bd3ad76"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.5},{\"width\":0.5}]}";
      "kwinrc"."Wayland"."VirtualKeyboardEnabled" = true;
      "kwinrc"."Windows"."BorderlessMaximizedWindows" = true;
      "kwinrc"."Xwayland"."Scale" = 1;
      "kwinrc"."org.kde.kdecoration2"."BorderSizeAuto" = false;
      "kwinrulesrc"."76e683ca-380f-4ced-8a5d-34f74f687440"."Description" = "By default on first desktop";
      "kwinrulesrc"."76e683ca-380f-4ced-8a5d-34f74f687440"."desktops" = "ce5d9ef9-3726-426b-99a2-6503e0a145e2";
      "kwinrulesrc"."76e683ca-380f-4ced-8a5d-34f74f687440"."desktopsrule" = 3;
      "kwinrulesrc"."76e683ca-380f-4ced-8a5d-34f74f687440"."wmclass" = ".*";
      "kwinrulesrc"."76e683ca-380f-4ced-8a5d-34f74f687440"."wmclassmatch" = 3;
      "kxkbrc"."Layout"."DisplayNames" = ",";
      "kxkbrc"."Layout"."LayoutDefaultGlobal" = 1;
      "kxkbrc"."Layout"."LayoutList" = "ru,us";
      "kxkbrc"."Layout"."Options" = "grp:win_space_toggle,compose:caps";
      "kxkbrc"."Layout"."ResetOldOptions" = true;
      "kxkbrc"."Layout"."Use" = true;
      "kxkbrc"."Layout"."VariantList" = ",";
      "plasma-localerc"."Formats"."LANG" = "ru_RU.UTF-8";
      "plasma-localerc"."Translations"."LANGUAGE" = "ru";
      "plasmarc"."OSD"."kbdLayoutChangedEnabled" = false;
      "plasmarc"."Theme"."name" = "breeze-dark";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/usr/share/backgrounds/warty-final-ubuntu.png";
